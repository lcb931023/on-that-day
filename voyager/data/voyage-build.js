...
// whole voyage to emerge (Iteration B). `rel` is the seeded relationship value; `kind`
// is the bond label (friend / rival / mentor — protege is inferred automatically for
// the other side). Everything past this is left to play: bonds escalate into feuds or
// cool into friendships as the crew actually lives together. Lives here (not in the
// Node-only loader) so pawns.js can import it in the browser too.
